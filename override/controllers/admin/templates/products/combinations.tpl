...
{if isset($product->id)}
  ...
  <h3 style="display: none">{l s='Add or modify combinations for this product' mod='combinationsfile'}</h3>
  ...
  <div class="panel-heading" style="display:none;">{l s='Add or modify combinations for this product' mod='combinationsfile'}</div>
  ...
  <div class="form-group" style="display:none;">
    <label class="control-label col-lg-3" for="attribute_price_impact">
      ...
      {l s='Impact on price' mod='combinationsfile'}
    </label>
    <div class="col-lg-9">
      <div class="row">
        <div class="col-lg-4">
  ...
  <div class="panel-footer">
        ...
        <span id="ResetSpan">
              ...
              <i class="icon-undo"></i> {l s='Save and stay' mod='combinationsfile'}
            </button>
                </span>
  </div>
  ...
  <div id="hiddenCombinationsGroup" {if $isSuperAdmin == false}style="display:none"{/if}>
  {$list}
  </div>
  <div class="panel-footer">
    ...
    <button type="submit" id="submitAddproductAndStay" name="submitAddproductAndStay" class="btn btn-default pull-right"><i class="process-icon-save"></i> {l s='Save and stay' mod='combinationsfile'}</button>
    <a href="#" id="desc-product-newCombination" style="display: none" class="btn btn-default pull-right"><i class="process-icon-new"></i> <span>{l s='New combination' mod='combinationsfile'}</span></a>
  </div>
  </div>
