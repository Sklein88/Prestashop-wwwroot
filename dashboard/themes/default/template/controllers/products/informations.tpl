...
<div id="product-informations" class="panel product-tab">
	...
	<div class="form-group" style="display:none">
		...
		<div class="col-lg-9">
			<div class="radio" {if $isPhotographer}style="display: none"{/if}>
	...
	<div class="form-group">
		...
		<div class="col-lg-5">
			<input type="text" id="reference" name="reference" value="{$product->reference|htmlentitiesUTF8}" {if $product->id == 0}placeholder="Reference code is auto generated" {/if} disabled="disabled" />
		</div>
	</div>
	...
	<div class="form-group" {if $isSuperAdmin == false}style="display:none"{/if}>
		...
		<div class="col-lg-3">
			<select name="visibility" id="visibility" {if $isSuperAdmin == false}disabled="disabled"{/if}>
