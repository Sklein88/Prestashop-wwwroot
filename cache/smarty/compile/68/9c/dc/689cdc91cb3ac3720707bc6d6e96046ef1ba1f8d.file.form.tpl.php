<?php /* Smarty version Smarty-3.1.19, created on 2017-03-25 11:23:30
         compiled from "C:\inetpub\wwwroot\override\controllers\admin\templates\products\helpers\form\form.tpl" */ ?>
<?php /*%%SmartyHeaderCode:1337758a4e94355f445-38611993%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '689cdc91cb3ac3720707bc6d6e96046ef1ba1f8d' => 
    array (
      0 => 'C:\\inetpub\\wwwroot\\override\\controllers\\admin\\templates\\products\\helpers\\form\\form.tpl',
      1 => 1490455063,
      2 => 'file',
    ),
    '66be5a5334cfa53fa4912cedab4e315d6928d265' => 
    array (
      0 => 'C:\\inetpub\\wwwroot\\dashboard\\themes\\default\\template\\helpers\\form\\form.tpl',
      1 => 1460113476,
      2 => 'file',
    ),
    'd186021145c38e2a4f0560ac55f556cf0027696f' => 
    array (
      0 => 'C:\\inetpub\\wwwroot\\dashboard\\themes\\default\\template\\helpers\\form\\form_group.tpl',
      1 => 1460113476,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '1337758a4e94355f445-38611993',
  'function' => 
  array (
  ),
  'version' => 'Smarty-3.1.19',
  'unifunc' => 'content_58a4e945532fa3_48387373',
  'variables' => 
  array (
    'fields' => 0,
    'tabs' => 0,
...
<?php if ($_valid && !is_callable('content_58a4e945532fa3_48387373')) {function content_58a4e945532fa3_48387373($_smarty_tpl) {?><?php if (!is_callable('smarty_function_counter')) include 'C:\\inetpub\\wwwroot\\tools\\smarty\\plugins\\function.counter.php';
?>
...
?>
				<?php if ($_smarty_tpl->tpl_vars['tab']->value['name']!="Pack") {?>
					<a class="list-group-item <?php if ($_smarty_tpl->tpl_vars['tab']->value['selected']) {?>active<?php }?>" style="display: none" id="link-<?php echo $_smarty_tpl->tpl_vars['tab']->value['id'];?>
...
;
			...
			var empty_pack_msg = '<?php echo smartyTranslate(array('s'=>'This pack is empty. You will need to add at least one product to the pack before you can save.','js'=>1,'mod'=>'combinationsfile'),$_smarty_tpl);?>
';
			var empty_name_msg = '<?php echo smartyTranslate(array('s'=>'The product name is empty. You will at least need to enter a name for the default language before you can save the product.','js'=>1,'mod'=>'combinationsfile'),$_smarty_tpl);?>
';
			var empty_link_rewrite_msg = '<?php echo smartyTranslate(array('s'=>'The friendly URL is empty. You will at least need to enter a friendly URL for the default language before you can save the product.','slashes'=>1,'mod'=>'combinationsfile'),$_smarty_tpl);?>
';
			var reload_tab_title = '<?php echo smartyTranslate(array('s'=>'Confirmation','slashes'=>1,'mod'=>'combinationsfile'),$_smarty_tpl);?>
';
			var reload_tab_description = '<?php echo smartyTranslate(array('s'=>'A server error occurred while loading the tabs: some tabs could not be loaded.','js'=>1,'mod'=>'combinationsfile'),$_smarty_tpl);?>
'+'\n'+'<?php echo smartyTranslate(array('s'=>'Please try again by refreshing the page.','js'=>1,'mod'=>'combinationsfile'),$_smarty_tpl);?>
'+'\n'+'<?php echo smartyTranslate(array('s'=>'If you are still encountering this problem, please check your server logs or contact your hosting provider for assistance.','js'=>1,'mod'=>'combinationsfile'),$_smarty_tpl);?>
';
...
;
			...
			var error_heading_msg = '<?php echo smartyTranslate(array('s'=>'Error','js'=>1,'mod'=>'combinationsfile'),$_smarty_tpl);?>
';
			var error_continue_msg = '<?php echo smartyTranslate(array('s'=>'Continue','js'=>1,'mod'=>'combinationsfile'),$_smarty_tpl);?>
';
...
;
			...
			$(document).ready(function()
			{
				...
				//Better to show up wich ones are used as hide the unused for avoid UI blink
                //$('#link-Prices,#link-Suppliers ,#link-Customization  ,#link-Features ,#link-Quantities ,#link-Prices ,#link-Seo').css('display', 'none');
				//
                $('#link-Informations,#link-Combinations ,#link-Associations  ,#link-Images ,#link-Attachments').css('display', '');
				...
				$('.confirm_leave').live('click', function(){
					...
					return confirm("<?php echo smartyTranslate(array('s'=>'You will lose all unsaved modifications. Are you sure that you want to proceed?','js'=>1,'mod'=>'combinationsfile'),$_smarty_tpl);?>
");
				});
...
');
		...
		<script type="text/javascript">
			// <![CDATA[
				ThickboxI18nImage = "<?php echo smartyTranslate(array('s'=>'Image','mod'=>'combinationsfile'),$_smarty_tpl);?>
";
				ThickboxI18nOf = "<?php echo smartyTranslate(array('s'=>'of','mod'=>'combinationsfile'),$_smarty_tpl);?>
";
				ThickboxI18nClose = "<?php echo smartyTranslate(array('s'=>'Close','mod'=>'combinationsfile'),$_smarty_tpl);?>
";
				ThickboxI18nOrEscKey = "<?php echo smartyTranslate(array('s'=>'(or "Esc")','mod'=>'combinationsfile'),$_smarty_tpl);?>
";
				ThickboxI18nNext = "<?php echo smartyTranslate(array('s'=>'Next >','mod'=>'combinationsfile'),$_smarty_tpl);?>
";
				ThickboxI18nPrev = "<?php echo smartyTranslate(array('s'=>'< Previous','mod'=>'combinationsfile'),$_smarty_tpl);?>
";
		...
		<div id="product-tab-content-wait" style="display:none">
			<div id="loading"><i class="icon-refresh icon-spin"></i>&nbsp;<?php echo smartyTranslate(array('s'=>'Loading...','mod'=>'combinationsfile'),$_smarty_tpl);?>
</div>
		</div>
...
" />
			...
			<div class="alert alert-info draft" >
				<?php echo smartyTranslate(array('s'=>'Your product will be saved as a draft.','mod'=>'combinationsfile'),$_smarty_tpl);?>

				<a href="#" class="btn btn-default" onclick="submitAddProductAndPreview()" ><i class="icon-eye-open"></i>&nbsp;<?php echo smartyTranslate(array('s'=>'Save and preview','mod'=>'combinationsfile'),$_smarty_tpl);?>
</a>
...
" class="<?php if (!$_smarty_tpl->tpl_vars['tab']->value['selected']) {?>not-loaded<?php }?> product-tab-content" <?php if (!$_smarty_tpl->tpl_vars['tab']->value['selected']) {?>style="display:none"<?php }?>>
			...
			<input type="hidden" name="id_product_attribute_size" id="id_product_attribute_size" value="S" />
			...
			setup : function(ed) {
				...
				ed.on('keydown', function(ed, e) {
					...
					if (max != 'none')
					{
						...
						rest = max - count;
						if (rest < 0)
							textarea.parent('div').find('span.counter').html('<span style="color:red;"><?php echo smartyTranslate(array('s'=>'Maximum','mod'=>'combinationsfile'),$_smarty_tpl);?>
 '+ max +' <?php echo smartyTranslate(array('s'=>'characters','mod'=>'combinationsfile'),$_smarty_tpl);?>
 : '+rest+'</span>');
						else
...
<?php }?>
<?php }} ?>
<?php /* Smarty version Smarty-3.1.19, created on 2017-03-25 11:23:32
         compiled from "C:\inetpub\wwwroot\dashboard\themes\default\template\helpers\form\form_group.tpl" */ ?>
<?php if ($_valid && !is_callable('content_58d68b74218c72_73858629')) {function content_58d68b74218c72_73858629($_smarty_tpl) {?>
