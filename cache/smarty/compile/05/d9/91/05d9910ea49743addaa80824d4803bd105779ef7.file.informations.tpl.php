<?php /* Smarty version Smarty-3.1.19, created on 2017-03-24 19:14:10
         compiled from "C:\inetpub\wwwroot\dashboard\themes\default\template\controllers\products\informations.tpl" */ ?>
<?php /*%%SmartyHeaderCode:2177758a4e942b21640-59858083%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '05d9910ea49743addaa80824d4803bd105779ef7' => 
    array (
      0 => 'C:\\inetpub\\wwwroot\\dashboard\\themes\\default\\template\\controllers\\products\\informations.tpl',
      1 => 1490397235,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '2177758a4e942b21640-59858083',
  'function' => 
  array (
  ),
  'version' => 'Smarty-3.1.19',
  'unifunc' => 'content_58a4e9430ffc76_33580156',
  'variables' => 
  array (
...
<?php if ($_valid && !is_callable('content_58a4e9430ffc76_33580156')) {function content_58a4e9430ffc76_33580156($_smarty_tpl) {?>
...
&updateproduct&id_product='+data.id_product;
 ...
 <?php echo smartyTranslate(array('s'=>'Type'),$_smarty_tpl);?>
		...
		<div class="col-lg-9">
			<div class="radio" <?php if ($_smarty_tpl->tpl_vars['isPhotographer']->value) {?>style="display: none"<?php }?>>
...
" placeholder="Reference code is auto generated" disabled="disabled" />
		</div>
	</div>
...
';
	...
	<div class="form-group" <?php if ($_smarty_tpl->tpl_vars['isSuperAdmin']->value==false) {?>style="display:none"<?php }?>>
		...
		<div class="col-lg-3">
			<select name="visibility" id="visibility" <?php if ($_smarty_tpl->tpl_vars['isSuperAdmin']->value==false) {?>disabled="disabled"<?php }?>>
